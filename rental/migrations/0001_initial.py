# Generated by Django 4.2.14 on 2024-07-31 19:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bikes', '0002_bike_bike_model_alter_bike_is_rented'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bike', models.ForeignKey(help_text='укажите велосипед', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rentals', to='bikes.bike', verbose_name='велосипед')),
